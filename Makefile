...
help:
	...
	@echo ""
	@echo " Firmware Per-IP Tests (runs on VeeR core, output visible in terminal):"
	@echo "   make test_uart                  - Test UART 16550 IP (6 subtests)"
	@echo "   make test_timer                 - Test Timer IP (4 subtests)"
	@echo "   make test_gpio                  - Test GPIO IP (3 subtests)"
	@echo "   make test_heartbeat             - Test Heartbeat Monitor IP (5 subtests)"
	@echo "   make test_reset_sequencer       - Test Reset Sequencer IP (4 subtests)"
	@echo "   make test_recovery_policy       - Test Recovery Policy IP (5 subtests)"
	@echo "   make test_vga                   - Test VGA Controller IP (5 subtests)"
	@echo "   make test_all_ips               - Run all per-IP tests in one firmware image"
	@echo "   make run_fw_test TEST=test/<f>  - Run any custom firmware test file"
	@echo ""
